...
let notepad = Item(
  ...
  price: 12.0,
  description: """
  6-pack of writing pads; 50 sheets of paper per pad; \
  ideal for everyday lists, notes, \
  and more.2 of each color (pink, orchid, and blue) for a nice appearance and optional color coding.
  """,
